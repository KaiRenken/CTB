...
TEST_CASE( "getCosystolicNorm", "[getCosystolicNorm]" ) {
    ...
    cochain->setEntry(1,0,1);
    cochain->setEntry(2,0,1);
    cochain->setEntry(3,0,0);
    cochain->setEntry(4,0,0);
    cochain->setEntry(5,0,0);
    cochain->setEntry(6,0,1);
    cochain->setEntry(7,0,0);
    cochain->setEntry(8,0,1);
    cochain->setEntry(9,0,0);

	Matrix* coboundaryMat = coboundaryMatrix(5, 0);

    REQUIRE( cochain->getCosystolicNorm(5, 1, coboundaryMat) == 1 );
...
TEST_CASE( "getCoboundaryExpansion", "[getCoboundaryExpansion]" ) {
    ...
    cochain->setEntry(9,0,0);
    cochain->setEntry(10,0,0);
    cochain->setEntry(11,0,1);
    cochain->setEntry(12,0,0);
    cochain->setEntry(13,0,0);
    cochain->setEntry(14,0,0);

    Matrix* coboundaryMat = coboundaryMatrix(6, 1);
    Matrix* coboundaryMat1 = coboundaryMatrix(6, 0);

    REQUIRE( cochain->getCoboundaryExpansion(6, 1, coboundaryMat, coboundaryMat1) == 2 );
